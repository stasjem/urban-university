...
class Bank(Thread):
    ...
    def deposit(self):
        ...
        for i in range(100):
            cashin = (random.randint(50, 500))

            if self.balance >= 500:
                self.balance += cashin
                print(f'Конец баланс {self.balance}')
                ...
                self.balance += cashin
                print(f"Пополнения {cashin}, Баланс {self.balance}")
                time.sleep(0.001)
            ...
            for i in range(100):
                ...
                if self.balance <= 0:
                    ...
                    if (self.balance-cash)<0:
                        ...
                        self.balance -= cash
                        print(f"Баланс {self.balance} уменьшен на {cash}")
